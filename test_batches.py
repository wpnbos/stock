...
from app.model import OrderLine, Batch, allocate, OutOfStock
...
def make_batch_and_line(sku: str, batch_quantity: int, order_line_quantity: int) -> tuple[Batch, OrderLine]:
    return (
        Batch("batch-001", sku, batch_quantity, eta=today), 
        OrderLine("order-123", sku, order_line_quantity)
    )
...
def test_cannot_allocate_if_skus_do_not_match(): 
    ...
    different_sku_line = OrderLine("order123", "EXPENSIVE-TOASTER", 10)
